...
public class SDTabCornerText extends SDTabCorner
{
	...
	{
		getViewConfig(mTvTitle).setTextColorNormal(getLibraryConfig().getColorMain()).setTextColorSelected(Color.WHITE);
	...
	{
		getViewConfig(mTvTitle).setTextColorNormal(Color.WHITE).setTextColorSelected(getLibraryConfig().getColorMain());
