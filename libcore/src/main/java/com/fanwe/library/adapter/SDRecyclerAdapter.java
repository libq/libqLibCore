        ...
        SDSelectManager.SelectCallback<T>
{
    ...
    public void setData(List<T> list)
    {
        ...
        mSelectManager.synchronizedSelected();
    }
    ...
    public void appendData(T model)
    {
        if (model != null)
        {
            ...
            mSelectManager.synchronizedSelected(model);
    ...
    public void appendData(List<T> list)
    {
        if (list != null && !list.isEmpty())
        {
            ...
            mSelectManager.synchronizedSelected(list);
    ...
    public T removeData(int position)
    {
        ...
        if (isPositionLegal(position))
        {
            mSelectManager.setSelected(position, false);
    ...
    public void insertData(int position, T model)
    {
        if (model != null)
        {
            ...
            mSelectManager.synchronizedSelected(position);
