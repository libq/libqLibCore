...
public class SDTitleSimple extends LinearLayout implements OnClickListener
{
    ...
    public void setTitleBackgroundColor(int color){
        ...
        if(mTitleLeft!=null){
            mTitleLeft.setItemBackgroundColor(color);
        }
        if(mTitleMiddle!=null){
            mTitleMiddle.setItemBackgroundColor(color);
        }
        if(mLlLeft!=null){
    ...
    {
        setBackgroundColor(mConfig.getColorTitleBarBackground());
    ...
    private Drawable getBackgroundItem()
    {
        ...
        none.color(mConfig.getColorTitleBarBackground());

        SDDrawable pressed = new SDDrawable();
        pressed.color(mConfig.getColorTitleBarItemPressed());
