...
public class SDTitle extends LinearLayout implements OnClickListener
{
	...
	private void findMaxItemRightCountByModeAutomatic()
	{
		...
		if (mWidthAvailable > 0)
		{
			...
			for (int i = 0; i < size; i++)
			{
				...
				currentWidth += SDViewUtil.getWidth(item);
			...
			if (mMaxItemRightCount == 0)
			{
				...
				int moreWidth = SDViewUtil.getWidth(moreItem);
				...
				} else
				{
					...
					SDViewUtil.setWidth(moreItem, leftWidth);
				}
			}
		}
	...
	private int getAvailableWidth()
	{
		...
		{
		case DEFAULT:
			availableWidth = (SDViewUtil.getWidth(this) - SDViewUtil.getWidth(mLlMiddle)) / 2;
			break;
		default:
			break;
		}
	...
	// ---------------------setCustomView
	public SDTitle setCustomViewLeft(View view, LayoutParams params)
	{
		mLlLeft.removeAllViews();
	...
	public SDTitle setCustomViewMiddle(View view, LayoutParams params)
	{
		mLlMiddle.removeAllViews();
	...
	public SDTitle setCustomViewRight(View view, LayoutParams params)
	{
		removeAllRightItems();
	...
	{
		this.removeAllViews();
		this.addView(mView, new LayoutParams(LayoutParams.MATCH_PARENT, height, 1));
		return this;
	}
	...
	private void setDefaultConfig()
	{
		...
		setHeightTitle(mConfig.getHeightTitleBar());
	}
	...
	private SDTitleColorCreater mColorCreater = new SDTitleColorCreater()
	{
		...
		{
			return mConfig.getColorTitleBarItemPressed();
		}

		@Override
		public int getColorNormal()
		{
			return mConfig.getColorTitleBarBackground();
		}
