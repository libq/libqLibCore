...
public class SDCollectionUtil
{
    ...
    public static <K, V> List<Map.Entry<K, V>> sortMap(Map<K, V> map, Comparator<Map.Entry<K, V>> comparator, List<Map.Entry<K, V>> listResult)
    {
        ...
        listResult.clear();
        listResult.addAll(map.entrySet());
