...
public class SDTabCorner extends SDViewBase
{
	...
	{
		getViewConfig(mTvTitle).setmTextColorNormal(mLibraryConfig.getColorMain());
	...
	public void reverseDefaultConfig()
	{
		...
		getViewConfig(mTvTitle).setmTextColorSelected(mLibraryConfig.getColorMain());
	...
	private SDDrawable createDefaultBackgroundNormal()
	{
		...
		drawableNormal.strokeColor(mLibraryConfig.getColorMain());
		drawableNormal.strokeWidthAll(mLibraryConfig.getWidthStroke());
		drawableNormal.cornerAll(mLibraryConfig.getCorner());
	...
	private SDDrawable createDefaultBackgroundSelected()
	{
		...
		drawableSelected.color(mLibraryConfig.getColorMain());
		drawableSelected.strokeColor(mLibraryConfig.getColorMain());
		drawableSelected.strokeWidthAll(mLibraryConfig.getWidthStroke());
		drawableSelected.cornerAll(mLibraryConfig.getCorner());
	...
	{
		SDDrawable drawableNormal = new SDDrawable();
		drawableNormal.color(mLibraryConfig.getColorMain());
