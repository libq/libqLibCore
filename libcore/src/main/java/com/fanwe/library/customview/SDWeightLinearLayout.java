...
public class SDWeightLinearLayout extends LinearLayout
{
    ...
    public void startWeightView()
    {
        calculateWidth(this, new CalculateWidthListener()
        {
            ...
            public void onResult(int width0, int width1, int widthTotal, int widthLeft, ViewGroup parent)
            {
                ...
                {
                    // 空间不够
                    SDViewUtil.setWidthWeight(parent.getChildAt(0), 1);
                } else
                {
                    SDViewUtil.setWidthWrapContent(parent.getChildAt(0));
                }
            }
        });
    }
    ...
    public static void calculateWidth(final ViewGroup parent, final CalculateWidthListener listener)
    {
        ...
        int width0 = SDViewUtil.getWidth(child0);
        int width1 = SDViewUtil.getWidth(child1);
        ...
        MarginLayoutParams params1 = SDViewUtil.getMarginLayoutParams(child1);
        if (params1 != null)
        {
        ...
        MarginLayoutParams params0 = SDViewUtil.getMarginLayoutParams(child0);
        if (params0 != null)
        {
